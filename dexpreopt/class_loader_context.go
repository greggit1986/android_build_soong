...
//jjedit	for ver, _ := range nestedClcMap {
//jjedit		if ver != AnySdkVersion {
//jjedit			clcStr, _ := ComputeClassLoaderContext(nestedClcMap)
//jjedit			return fmt.Errorf("nested class loader context shouldn't have conditional part: %s", clcStr)
//jjedit		}
//jjedit	}
